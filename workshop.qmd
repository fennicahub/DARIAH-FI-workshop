...
## Classic separation / sparsity problem
...
## Collapse professions into meaningful groups
...
df <- df %>%
  mutate(
    profession_group = case_when(
      ...
      profession_metadata_profession_prefLabel_fi %in%
        c("lääkäri", "lääkäri, professori") ~ "lääketiede",
